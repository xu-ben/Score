...
public class DBOperator {
	...
	private static void getACCodeOfAContestToDir(int id) {
		...
		String root = "G:\\tt\\Java程序设计实验" + (id - 9) + "Accepted的代码";
		String dir;
		int k;
	...
	private static void getCodeToFilesFromAContest(int id) {
		...
		String[] namelist = getNameListOfAContest(id);
		String root = "G:\\tt\\Java程序设计2010年秋期末考试所有提交代码（按用户分文件存放）\\";
		String dir;
	...
	public static void main_old(String[] args) {
		...
		DBOperator.setFileText("G:\\t\\Java程序设计实验" + (id - 9) + "代码存档.doc", s);
